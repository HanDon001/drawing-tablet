...
(function() {
    ...
    VC.Drawing = {
        ...
        _bindEvents() {
            ...
            drawCanvas.addEventListener('touchend', () => this._onPointerUp());
        },

        /**
         * 获取画布坐标（考虑 DPR 和 offset）
         */
        _getPos(e) {
        ...
        _onPointerMove(e) {
            ...
            const pos = this._getPos(e);
            this._drawLine(lastX, lastY, pos.x, pos.y);
            lastX = pos.x;
            lastY = pos.y;
        },
        ...
        _drawDot(x, y) {
            ...
            drawCtx.beginPath();
            drawCtx.arc(x, y, brush.size / 2, 0, Math.PI * 2);
            drawCtx.fill();
